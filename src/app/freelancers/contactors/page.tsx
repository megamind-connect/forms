...
const FreelancerRegistration = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      submitData.append('registrationCategory', 'CREATIVE_PARTNER');
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-16">
          ...
          <section className="space-y-10">
            <h2 className="text-xl font-bold text-[#202020] uppercase border-b pb-2">Basic Details</h2>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-start">
    <div className="space-y-2 md:space-y-4">
      {/* Invisible label purely for alignment with the adjacent input field */}
      <label className="text-sm font-medium text-transparent hidden md:block select-none" aria-hidden="true">
        Spacer
      </label>
      <Checkbox
        name="isDeclared"
