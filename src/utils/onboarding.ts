export const generalFields = [
  ...
  { id: "email", name: "business_email_id", label: "Business Email ID", placeholder: "Official business email", fieldType: "email" },
  {
    ...
    placeholder: "Official business landline/Mobile number",
    fieldType: "array",
    optional: true,
  },
  // {
...
export const socialMediaAccessFields = [
  ...
  { id: "sma_bm_invite_desc", name: "bm_invite_desc", label: "Setting – Users – People → Click on Invite → Add Email IDs → Studiosmegamind@gmail.com & Vishnuklyd123@gmail.com → Click on Everything to Grant Full Access (Business Manager + Ads Manager + Facebook + Instagram)", fieldType: "description_text", dependsOn: "bm_invite_toggle" },
  ...
  { id: "sma_gmb_invite_desc", name: "gmb_invite_desc", label: "Google Business Profile → Click on Three Dot Menu → Business Profile Setting → People and Access → Add → Email Id - Studiosmegamind@gmail.com → Access – Owner → Invite", fieldType: "description_text", dependsOn: "gmb_invite_toggle" },
];

export const ppcSpecificFields = [

  { id: "ppc_header_bm", name: "bm_header", label: "Meta Business Manager", fieldType: "header", hasToggle: true   },
  { id: "ppc_bm_access_title", name: "bm_access_toggle", label: "Access of Meta Business Manager", fieldType: "toggle" },
  { id: "ppc_bma", name: "bm_email", label: "User Id", fieldType: "text", placeholder:  " User Id", dependsOn: "bm_access_toggle" },
  { id: "ppc_bmb", name: "bm_password", label: "Password", fieldType: "password", placeholder: "Password", dependsOn: "bm_access_toggle" },
  { id: "ppc_bm_or", name: "bm_or", label: "Or", fieldType: "or_divider" },
  { id: "ppc_bm_invite_title", name: "bm_invite_toggle", label: "Provide access via an official platform invite", fieldType: "toggle" },
  { id: "ppc_bm_invite_desc", name: "bm_invite_desc", label: "Setting – Users – People → Click on Invite → Add Email IDs → Studiosmegamind@gmail.com & Vishnuklyd123@gmail.com → Click on Everything to Grant Full Access (Business Manager + Ads Manager + Facebook + Instagram)", fieldType: "description_text", dependsOn: "bm_invite_toggle" },
